...
public class OverlayImpl extends JavaScriptObject implements Overlay {
    ...
    @Override
    public final List<? extends Overlay> getList(final String key) {
        final JsArray<OverlayImpl> nestedOverlay = (JsArray<OverlayImpl>) getNestedOverlay(key);
     ...
     * @return
     */
    private List<? extends Overlay> toList(final JsArray<OverlayImpl> nestedOverlay) {
        final ArrayList<Overlay> arrayList = new ArrayList<Overlay>(nestedOverlay.length());
