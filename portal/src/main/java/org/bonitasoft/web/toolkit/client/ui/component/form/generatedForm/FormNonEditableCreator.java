 ...
 * @author Nicolas Tith
 */
public class FormNonEditableCreator implements FormNodeCreator {

    public FormNode create(ItemBinding item) {
        StaticText text = new StaticText(new JsId(item.getAttributeName()), item.getNonEditableLabel(), item.getValue());
        return text;
    }
