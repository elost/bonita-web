 ...
 */
abstract class TableFilter extends TableComponent {
    ...
    public TableFilter(final Table table, final String label, final String tooltip, final String name) {
        this(table, label, tooltip, name, null);
    }

    public TableFilter(final Table table, final String label, final String tooltip, final String name, final String value) {
        super(table);
        this.name = name;
        this.label = label;
