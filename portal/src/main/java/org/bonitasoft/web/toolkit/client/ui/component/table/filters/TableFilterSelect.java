...
public class TableFilterSelect extends TableFilter {
    ...
    public TableFilterSelect(final String label, final String tooltip, final String name) {
        super(label, tooltip, name, null);
    }

    public TableFilterSelect(final String label, final String tooltip, final String name, final String value) {
