 ...
 */
public abstract class SelectRoleAndDoPageOnItem<T extends IItem> extends SelectItemAndDoPageOnItem<T> {

    public static String ROLE_ID = "role_id";

    public SelectRoleAndDoPageOnItem(final APIID itemId, final ItemDefinition itemDefinition) {
        super(itemId, itemDefinition);
    }

    public SelectRoleAndDoPageOnItem(final ItemDefinition itemDefinition) {
        super(itemDefinition);
    }

    public SelectRoleAndDoPageOnItem(final String itemId, final ItemDefinition itemDefinition) {
        super(itemId, itemDefinition);
    }
