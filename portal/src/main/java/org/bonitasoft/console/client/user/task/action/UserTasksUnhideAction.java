 ...
 * @author Julien Mege
 */
public class UserTasksUnhideAction extends ActionOnItemIds {

    private APIID userId;

    public UserTasksUnhideAction() {
        super();
    }

    public UserTasksUnhideAction(APIID userId, APIID... taskIds) {
        super(taskIds);
        this.userId = userId;
    }
    ...
    protected void execute(final List<APIID> taskIds) {
        TaskAPI.unhide(taskIds, userId.toString(), new RefreshPageAction());
    }
}
