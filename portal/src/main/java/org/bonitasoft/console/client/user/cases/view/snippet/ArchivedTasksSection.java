...
public class ArchivedTasksSection extends Section {
    ...
    public ArchivedTasksSection(final String title, final CaseItem item, final int nbLinesByPage) {
        super(title);
    ...
    protected ItemTable getTaskTable(final CaseItem item) {
        final ItemTable table = new ItemTable(new JsId("tasks"), ArchivedHumanTaskDefinition.get());
