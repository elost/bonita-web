 ...
 * @author Colin PUY
 */
public class ShowAddGroupToActorPageAction extends Action {

    private final String actorId;

    public ShowAddGroupToActorPageAction(String actorId) {
        this.actorId = actorId;
    }

    @Override
    public void execute() {
        final SelectGroupForActorPage popup = new SelectGroupForActorPage();
