 ...
 */
public class ArchivedCasesFiller extends Filler<Link> {

    private final ProcessItem process;

    public ArchivedCasesFiller(final ProcessItem process) {
    ...
    protected void setData(final String json, final Map<String, String> headers) {
        ...
        this.target.setLabel(_("%nb_archived% archived", new Arg("nb_archived", resultPager.getNbTotalResults())));
