 ...
 */
public class TaskRelaseAction extends ActionOnItemIds {

    public TaskRelaseAction() {
        super();
    }

    public TaskRelaseAction(final APIID... taskIds) {
        super(taskIds);
    }

    public TaskRelaseAction(final List<APIID> taskIds) {
        super(taskIds);
    }

    @Override
    protected void execute(final List<APIID> taskIds) {
        TaskAPI.release(taskIds, new RefreshPageAction());
    }
