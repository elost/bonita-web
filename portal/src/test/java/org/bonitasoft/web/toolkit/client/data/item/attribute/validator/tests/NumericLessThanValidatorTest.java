...
import org.bonitasoft.web.toolkit.client.data.item.attribute.validator.NumericLessThanValidator;
 ...
 * @author Paul AMAR
 */
public class NumericLessThanValidatorTest {
    ...
    public void testLessThanOK() {
        final NumericLessThanValidator test = new NumericLessThanValidator("");
        test.check("5", "10");
        assertFalse(test.hasError());
    }

    @Test
    public void testLessThanErreur() {
        final NumericLessThanValidator test = new NumericLessThanValidator("");
        test.check("10", "10");
