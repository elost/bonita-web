...
import org.bonitasoft.web.toolkit.client.data.item.attribute.modifier.PrefixModifier;
 ...
 * @author Paul AMAR
 */
public class PrefixModifierTest {
    ...
    public void TestPrefixOk() {
        final PrefixModifier test = new PrefixModifier("prefix");
        final String result = test.clean("machaine");
        assertTrue(result.equals("prefixmachaine"));
    }
