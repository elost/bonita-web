...
import org.bonitasoft.web.toolkit.client.data.item.attribute.validator.NumericEqualsTo;
 ...
 * @author Paul AMAR
 */
public class TestNumericEqualsTo {
    ...
    public void testErreurEmptyString() {
        final NumericEqualsTo test = new NumericEqualsTo("");
        test.check("", "");
    ...
    @Test
    public void testNumericEqualOK() {
        final NumericEqualsTo test = new NumericEqualsTo("");
        test.check("10", "10");
        assertFalse(test.hasError());
    }
