...
public class CustomUserInformationModelTest {
    ...
    @Test
    public void should_search_for_the_user_custom_information() {
        final CustomUserInformationModel model = new CustomUserInformationModel(requestFactory, "3");
    ...
    @Test
    public void should_send_value_change_on_flush() {
        final CustomUserInformationModel model = new CustomUserInformationModel(requestFactory, "6");
        final CustomUserInfoItem item = createInformation(6L, 2L);
    ...
    @Test
    public void should_send_all_changed_values_on_flush() {
        final CustomUserInformationModel model = new CustomUserInformationModel(requestFactory, "6");
        final CustomUserInfoItem information1 = createInformation(5L, 8L);
        final CustomUserInfoItem information2 = createInformation(7L, 4L);
    ...
    @Test
    public void should_send_an_information_value_change_only_once() {
        final CustomUserInformationModel model = new CustomUserInformationModel(requestFactory, "6");
        final CustomUserInfoItem information = createInformation(4L, 1L);
    ...
    private CustomUserInfoItem createInformation(final long userId, final long definitionId) {
