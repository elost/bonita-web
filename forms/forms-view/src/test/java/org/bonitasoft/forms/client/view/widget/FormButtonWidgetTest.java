...
public class FormButtonWidgetTest {
    ...
    @Test
    public void testAddClickHandler_and_click_should_trigger_handler() {
    ...
    @Test
    public void testAddClickHandler_twice_and_click_should_trigger_handler_once() {
        final ClickHandler clickHandler = mock(ClickHandler.class);
        buttonWidget.addClickHandler(clickHandler);
        buttonWidget.addClickHandler(clickHandler);
        final ClickEvent clickEvent = mock(ClickEvent.class);
    ...
    @Test
    public void testAddClickHandler_with_id_and_click_should_trigger_handler() {
        final ClickHandler clickHandler = mock(ClickHandler.class);
    ...
    @Test
    public void testAddClickHandler_with_id_twice_and_click_should_trigger_handler_once() {
        final ClickHandler clickHandler = mock(ClickHandler.class);
        buttonWidget.addClickHandler("form", clickHandler);
        buttonWidget.addClickHandler("form", clickHandler);
        final ClickEvent clickEvent = mock(ClickEvent.class);
    ...
    @Test
    public void testAddClickHandler_with_id_twice_and_without_once_and_click_should_trigger_handler_once() {
        final ClickHandler clickHandler = mock(ClickHandler.class);
        buttonWidget.addClickHandler("form", clickHandler);
        buttonWidget.addClickHandler("form", clickHandler);
        buttonWidget.addClickHandler(clickHandler);
    ...
    @Test
    public void test_two_AddClickHandler_with_id_twice_and_once_and_click_should_trigger_handler_once_each() {
        final ClickHandler clickHandler1 = mock(ClickHandler.class);
        final ClickHandler clickHandler2 = mock(ClickHandler.class);
