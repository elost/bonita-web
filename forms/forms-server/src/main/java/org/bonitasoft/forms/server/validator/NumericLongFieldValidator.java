...
/**
 * Validator forbidding anything else than a Long value in a form field
 * 
 * @author Anthony Birembaut
 */
public class NumericLongFieldValidator implements IFormFieldValidator {
    ...
    public boolean validate(final FormFieldValue fieldInput, final Locale locale) {
        if (fieldInput.getValue() instanceof Long) {
            return true;
