...
/**
 * Validator forbidding anything else than an Integer value in a form field
 * 
 * @author Anthony Birembaut
 */
public class NumericIntegerFieldValidator implements IFormFieldValidator {
    ...
    public boolean validate(final FormFieldValue fieldInput, final Locale locale) {
        if (fieldInput.getValue() instanceof Integer) {
            return true;
