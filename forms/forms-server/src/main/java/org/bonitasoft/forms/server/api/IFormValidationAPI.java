...
public interface IFormValidationAPI {
    ...
    List<FormValidator> validateActivityField(APISession session, long activityInstanceID, List<FormValidator> validators, String fieldId,
            ...
            BPMEngineException, InvalidSessionException, FileTooBigException, IOException, ArchivedProcessInstanceNotFoundException,
            ArchivedFlowNodeInstanceNotFoundException, BPMExpressionEvaluationException;
    ...
    List<FormValidator> validateActivityPage(APISession session, long activityInstanceID, List<FormValidator> validators, Map<String, FormFieldValue> fields,
            ...
            InvalidSessionException, FileTooBigException, IOException, ArchivedProcessInstanceNotFoundException, ArchivedFlowNodeInstanceNotFoundException,
