...
/**
 * Validator forbidding anything else than a Float value in a form field
 * 
 * @author Anthony Birembaut
 */
public class NumericFloatFieldValidator implements IFormFieldValidator {
    ...
    public boolean validate(final FormFieldValue fieldInput, final Locale locale) {
        if (fieldInput.getValue() instanceof Float) {
            return true;
