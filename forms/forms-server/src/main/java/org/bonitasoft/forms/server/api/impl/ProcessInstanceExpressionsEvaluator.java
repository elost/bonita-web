...
public class ProcessInstanceExpressionsEvaluator {
    ...
    private final ExpressionEvaluatorEngineClient engineEvaluator;

    public ProcessInstanceExpressionsEvaluator(final ExpressionEvaluatorEngineClient engineEvaluator) {
        this.engineEvaluator = engineEvaluator;
    }

    public Map<String, Serializable> evaluate(final ProcessInstanceAccessor instance, final Map<Expression, Map<String, Serializable>> expressions,
            final boolean atProcessInstanciation) throws BPMExpressionEvaluationException {
    ...
    private Map<String, Serializable> evaluateExpressionsOnCompleted(final long processInstanceID,
            final Map<Expression, Map<String, Serializable>> expressions) throws BPMExpressionEvaluationException {
        return engineEvaluator.evaluateExpressionsOnCompletedProcessInstance(processInstanceID, expressions);
    }

    private Map<String, Serializable> evaluateExpressionsOnProcessInstance(final long processInstanceID,
            final Map<Expression, Map<String, Serializable>> expressions) throws BPMExpressionEvaluationException {
        return engineEvaluator.evaluateExpressionsOnProcessInstance(processInstanceID, expressions);
    }
}
