 ...
 */
public interface ModifiableOutput {

    public List<Modifier> getOutputModifiers();

    public ModifiableOutput addOutputModifier(final Modifier modifier);

    public ModifiableOutput addOutputModifiers(final List<Modifier> modifiers);

    public ModifiableOutput removeOutputModifier(final String modifierClassName);
