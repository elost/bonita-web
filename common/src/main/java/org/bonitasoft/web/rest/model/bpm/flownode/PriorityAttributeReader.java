 ...
 * @author Julien Mege
 */
public class PriorityAttributeReader extends AttributeReader {

    public PriorityAttributeReader(final String attributeToRead) {
        super(attributeToRead, false);

        addOutputModifier(new PriorityModifier());
    }
