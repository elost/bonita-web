...
public class ItemSearchResultConverterTest {
    ...
    public void testTotalCanBeRetrieved() {
        ...
        final ItemSearchResultConverter<IItem, String> itemSearchResult = new ItemSearchResultConverter<IItem, String>(3, 2, result, converter);
    ...
    public void testTotalSettedCanBeRetrieved() {
        final ItemSearchResultConverter<IItem, String> itemSearchResult = new ItemSearchResultConverter<IItem, String>(3, 2, result, 8L, converter);
    ...
    public void testNumberOfResultCanBeRetrieved() {
        ...
        final ItemSearchResultConverter<IItem, String> itemSearchResult = new ItemSearchResultConverter<IItem, String>(3, 10, result, 4L, converter);

        assertEquals(3, itemSearchResult.toItemSearchResult().getLength());
    }

    @Test(expected = APISearchIndexOutOfRange.class)
    public void testPageOutOfResultNumberThrowsExecption() {
    ...
    public void testPageNumberCanBeRetrieved() {
        final ItemSearchResultConverter<IItem, String> itemSearchResult = new ItemSearchResultConverter<IItem, String>(5, 10, result, 8L, converter);
    ...
    public void testResultingItemsCanBeRetrieved() {
        final IItem item1 = mock(IItem.class);
        final IItem item2 = mock(IItem.class);
        when(result.getResult()).thenReturn(asList("item1", "item2"));
        when(converter.convert(result.getResult())).thenReturn(asList(item1, item2));

        final ItemSearchResultConverter<IItem, String> itemSearchResult = new ItemSearchResultConverter<IItem, String>(1, 10, result, 2, converter);
