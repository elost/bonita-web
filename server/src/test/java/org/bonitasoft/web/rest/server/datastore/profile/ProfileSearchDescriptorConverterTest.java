...
public class ProfileSearchDescriptorConverterTest {
    ...
    public void testWeCanConvertTheProfileId() {
        final String descriptor = new ProfileSearchDescriptorConverter().convert(ProfileItem.ATTRIBUTE_ID);
    ...
    public void testWeCanConvertTheProfileName() {
        final String descriptor = new ProfileSearchDescriptorConverter().convert(ProfileItem.ATTRIBUTE_NAME);
