...
public class GenericFilterCreatorTest {
    ...
    @Test
    public void testGenericFilterCreator() {
        when(converter.convert("attribute"))
                .thenReturn("attribute");
        final GenericFilterCreator creator = new GenericFilterCreator(converter);

        final Filter<String> filter = creator.create("attribute", "value");
