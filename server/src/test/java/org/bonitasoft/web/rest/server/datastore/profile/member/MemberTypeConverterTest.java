...
public class MemberTypeConverterTest {
    ...
    @Test
    public void testMemberTypeConversion() {
        final MemberTypeConverter converter = new MemberTypeConverter();

        final MemberType value = converter.convert(AbstractMemberItem.VALUE_MEMBER_TYPE_ROLE);
