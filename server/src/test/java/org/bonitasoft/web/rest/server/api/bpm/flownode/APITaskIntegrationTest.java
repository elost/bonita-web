...
public class APITaskIntegrationTest extends AbstractConsoleTest {
    ...
    public void api_can_search_with_default_search_order() throws Exception {
        ...
        //when
        final ItemSearchResult<TaskItem> searchResultWithNoOrder = apiTask.runSearch(0, 1, null, null, null, null, null);
