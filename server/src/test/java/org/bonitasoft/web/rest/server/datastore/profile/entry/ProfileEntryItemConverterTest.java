...
public class ProfileEntryItemConverterTest extends APITestWithMock {
    ...
    @Test
    public void testWeCanConverteAProfileEntry() {
        final ProfileEntry profileEntry = anEngineProfileEntry().withCustomName("customName").build();

        final ProfileEntryItem item = new ProfileEntryItemConverter().convert(profileEntry);
