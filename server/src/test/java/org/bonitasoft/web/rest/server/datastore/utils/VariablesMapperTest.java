...
public class VariablesMapperTest {
    ...
    @Test
    public void variablesMapper_convert_json_variable_list_to_variableMappers() {

        final VariablesMapper variablesMapper = VariablesMapper.fromJson(JSON_VARIABLES);
    ...
    private VariableMapper aVariableMapper(final String name, final Object value) {
