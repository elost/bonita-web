...
public class GroupEngineClientTest extends APITestWithMock {
    ...
    @Test
    public void get_get_a_group_in_engine_repository() throws GroupNotFoundException {
    ...
    public void get_throw_APIException_if_group_is_not_found_in_engine_repository() throws GroupNotFoundException {
    ...
    @Test
    public void delete_delete_groups_in_engine_repository() throws DeletionException {
        final List<Long> groupIds = asList(1L, 2L);
    ...
    @Test(expected = APIException.class)
    public void delete_throw_APIException_if_an_error_occurs_when_deleting_groups_in_engine_repository() throws DeletionException {
        final List<Long> groupIds = asList(1L, 2L);
    ...
    @Test
    public void update_update_a_group_in_engine_repository() throws GroupNotFoundException, UpdateException {
    ...
    @Test(expected = APIException.class)
    public void update_throw_APIException_if_group_not_exists_in_engine_repository() throws GroupNotFoundException, UpdateException {
    ...
    @Test(expected = APIException.class)
    public void update_throw_APIException_if_an_exception_occurs_when_updating_in_engine_repository() throws GroupNotFoundException, UpdateException {
    ...
    @Test(expected = APIException.class)
    public void getPath_throw_APIexception_if_groupId_is_not_a_number() {
        groupEngineClient.getPath("notANumber");
    }

    @Test
    public void getPath_return_the_group_path_for_the_specified_group_id() throws GroupNotFoundException {
        final Group group = mock(Group.class);
        when(group.getPath()).thenReturn("/expected/group/path");
        when(groupAPI.getGroup(1L)).thenReturn(group);

        final String groupPath = groupEngineClient.getPath("1");
    ...
    public void create_create_a_group_in_engine_repository() throws Exception {
        final GroupCreator creator = new GroupCreator("aName");
