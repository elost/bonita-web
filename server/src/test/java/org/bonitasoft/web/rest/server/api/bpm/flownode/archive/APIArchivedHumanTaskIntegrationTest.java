...
public class APIArchivedHumanTaskIntegrationTest extends AbstractConsoleTest {
    ...
    public void archivedHumanTasksCanBeSortedByReachedStateDate() {
        final Map<String, String> filters = buildArchivedHumanTaskStateCompletedForCaseIdFilter(makeAPIID(1L));
        final String orders = ArchivedHumanTaskItem.ATTRIBUTE_REACHED_STATE_DATE + " DESC";
