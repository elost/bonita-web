...
public class APIProcessConnectorTest extends APITestWithMock {
    ...
    public void initializeMocks() {
        ...
        doReturn(processConnectorDatastore).when(apiProcessConnector).defineDefaultDatastore();
    }

    @Test(expected = APIFilterMandatoryException.class)
    public void whenSearchingFilterProcessIdIsMandatory() {
        apiProcessConnector.search(0, 10, null, null, EMPTY_MAP);
    }

    @Test
    public void searchIsDoneWhenProcessIdFilterIsSet() {
