...
public class ProfileMemberItemConverterTest extends APITestWithMock {
    ...
    public void testProfileMemberItemConversion() {
        final ProfileMemberItemConverter converter = new ProfileMemberItemConverter();
        final ProfileMember profileMember = anEngineProfileMember().build();

        final ProfileMemberItem item = converter.convert(profileMember);
