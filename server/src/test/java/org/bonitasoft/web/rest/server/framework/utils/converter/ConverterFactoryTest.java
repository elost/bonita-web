...
public class ConverterFactoryTest {
    ...
    public void factoryCreateABooleanConverterForBooleanClassName() {
        ...
        final Converter<?> createConverter = factory.createConverter(Boolean.class.getName());
    ...
    public void factoryCreateADateConverterForDateClassName() {

        final Converter<?> createConverter = factory.createConverter(Date.class.getName());
    ...
    public void factoryCreateADoubleConverterForDoubleClassName() {
        ...
        final Converter<?> createConverter = factory.createConverter(Double.class.getName());
    ...
    public void factoryCreateALongConverterForLongClassName() {
        ...
        final Converter<?> createConverter = factory.createConverter(Long.class.getName());
    ...
    public void factoryCreateAStringConverterForStringClassName() {
        ...
        final Converter<?> createConverter = factory.createConverter(String.class.getName());
    ...
    public void factoryCreateAnIntegerConverterForIntegerClassName() {
        ...
        final Converter<?> createConverter = factory.createConverter(Integer.class.getName());
