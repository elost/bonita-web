...
public class APICaseVariableAttributeCheckerTest {
    ...
    @Test
    public void checkUpdateAttributesPassForSuitableValues() {
        final Map<String, String> attributes = buildSuitableUpdateAttributes();

        attributeChecker.checkUpdateAttributes(attributes);
    }

    @Test(expected = APIException.class)
    public void checkUpdateAttributesCheckForAttributeType() {
        final Map<String, String> attributes = buildSuitableUpdateAttributes();
    ...
    @Test(expected = APIException.class)
    public void checkUpdateAttributesCheckForAttributeValue() {
        final Map<String, String> attributes = buildSuitableUpdateAttributes();
    ...
    @Test
    public void checkSearchFiltersPassForSuitableValues() {
        final Map<String, String> filters = buildSuitableSearchFilters();

        attributeChecker.checkSearchFilters(filters);
    }

    @Test(expected = APIException.class)
    public void checkSearchFiltersCheckForCaseIdFilters() {
        final Map<String, String> filters = buildSuitableSearchFilters();
