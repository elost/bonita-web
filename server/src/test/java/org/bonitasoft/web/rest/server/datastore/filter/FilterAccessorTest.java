...
public class FilterAccessorTest {
    ...
    @Test
    public void testWeCanRetrieveMandatoryValue() {
        final FilterAccessor filterAccess = new FilterAccessor(Collections.singletonMap("key", "value"));

        final String value = filterAccess.getMandatory("key");
    ...
    public void testAccessToMandatoryValueWhichItDoesntExitThrowException() {
        final FilterAccessor filterAccess = new FilterAccessor(Collections.<String, String> emptyMap());
