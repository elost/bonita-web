...
public class ConsoleServiceFactoryTest {
    ...
    @Test
    public void getService_should_return_OrganizationImportService_when_organization_import() {
        // Given
        final ConsoleServiceFactory consoleServiceFacotry = new ConsoleServiceFactory();

        // When
        final Service service = consoleServiceFacotry.getService("/organization/import");
    ...
    @Test
    public void getService_should_return_ProcessActorImportService_when_bpm_process_importActors() {
        // Given
        final ConsoleServiceFactory consoleServiceFacotry = new ConsoleServiceFactory();

        // When
        final Service service = consoleServiceFacotry.getService("/bpm/process/importActors");
