 ...
 */
public class StandardLoginManagerImplIntegrationTest extends AbstractJUnitWebTest {
    ...
    public void testLogin() {
        HttpServletRequestAccessor request = new HttpServletRequestAccessor(new MockHttpServletRequest());
        try {
            new StandardLoginManagerImpl()
                    .login(request,
