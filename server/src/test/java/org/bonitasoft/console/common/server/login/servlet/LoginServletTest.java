...
public class LoginServletTest {
    ...
    @Test
    public void testPasswordIsDroppedWhenParameterIsLast() {
    ...
    @Test
    public void testPasswordIsDroppedWhenParameterIsBeforeHash() {
        final LoginServlet servlet = new LoginServlet();
    ...
    @Test
    public void testUrlIsDroppedWhenParameterIsFirstAndBeforeHash() {
        final LoginServlet servlet = new LoginServlet();
    ...
    @Test
    public void testUrlStayTheSameIfNoPasswordArePresent() {
        final LoginServlet servlet = new LoginServlet();
    ...
    @Test
    public void testPasswordIsDroppedEvenIfQueryMarkUpIsntThere() {
        final LoginServlet servlet = new LoginServlet();
    ...
    @Test
    public void testUrlStayEmptyIfParameterIsEmpty() {
        final LoginServlet servlet = new LoginServlet();
    ...
    @Test
    public void testDropPasswordOnRealUrl() {
        final LoginServlet servlet = new LoginServlet();
