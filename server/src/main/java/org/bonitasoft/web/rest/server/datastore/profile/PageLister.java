...
public class PageLister {
    ...
    static {
        ...
        pages.add(new BonitaPageItem("tasklistingpm", _("Manage tasks of processes that an entity with this profile can supervise as PM."),
                _("Manage tasks of processes that an entity with this profile can supervise as PM."), _("Tasks")));
        ...
        pages.add(new BonitaPageItem("caselistingpm", _("Manage cases of processes that an entity with this profile can supervise as PM."),
                _("Manage cases of processes that an entity with this profile can supervise as PM."), _("Cases")));
        ...
        pages.add(new BonitaPageItem("processlistingpm", _("Manage processes that an entity with this profile can supervise as PM."),
                _("Manage processes that an entity with this profile can supervise as PM."), _("Processes")));
