        ...
        DatastoreHasDelete
{
    ...
    public ItemSearchResult<ActorMemberItem> search(final int page, final int resultsByPage, final String search, final String orders,
        ...
        try {
            ...
            final List<ActorMember> filteredResults = applyTypeFilter(filters.get(ActorMemberItem.FILTER_MEMBER_TYPE), unfilteredResults);

            @SuppressWarnings("unchecked")
            final List<ActorMember> paginatedResults = (List<ActorMember>) ListUtil.paginate(filteredResults, page, resultsByPage);
