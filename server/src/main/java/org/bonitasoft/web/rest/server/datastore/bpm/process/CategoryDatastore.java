...
public class CategoryDatastore extends CommonDatastore<CategoryItem, Category> implements
     ...
     */
    public long getNumberOfCategories(final long processId) {
        try {
    ...
    public ItemSearchResult<CategoryItem> search(final int page, final int resultsByPage, final String search, final String orders,
        ...
        try {
            final CategoryCriterion orderCrit = getOrder(orders);
    ...
    private ItemSearchResult<CategoryItem> searchCategories(final int page, final int resultsByPage, final CategoryCriterion orderCrit) {
        final List<Category> searchResult = getProcessAPI().getCategories(SearchOptionsBuilderUtil.computeIndex(page, resultsByPage),
                resultsByPage,
                orderCrit);
    ...
    private ItemSearchResult<CategoryItem> searchProcessCategories(final int page, final int resultsByPage, final Map<String, String> filters,
            final CategoryCriterion orderCrit) {
        final Long processId = Long.valueOf(filters.get(ProcessItem.ATTRIBUTE_ID));
        final List<Category> searchResult = getProcessAPI().getCategoriesOfProcessDefinition(processId,
