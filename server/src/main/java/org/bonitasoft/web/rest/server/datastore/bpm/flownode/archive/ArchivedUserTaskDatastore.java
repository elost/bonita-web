 ...
 */
public class ArchivedUserTaskDatastore extends AbstractArchivedUserTaskDatastore<ArchivedUserTaskItem, ArchivedUserTaskInstance> {

    public ArchivedUserTaskDatastore(final APISession engineSession) {
        super(engineSession);
    }
}
